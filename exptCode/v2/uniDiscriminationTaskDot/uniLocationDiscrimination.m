...
switch ExpInfo.practice
    case 1
        outFileName = sprintf('uniDisDot_sub-%s_ses-%s', ExpInfo.subjInit, ExpInfo.session);
    case 2
        outFileName = sprintf('uniDisDot_practice_sub-%s_ses-%s', ExpInfo.subjInit, ExpInfo.session);
end
...
elseif strcmp(ExpInfo.session, 'V2')
    VSinfo.SD_blob = 20; % cm in std of the gaussian blob
end
...
for i = 1:ExpInfo.n_trial
    ...
    for ss = 1:ExpInfo.n_staircase
        ...
        if strcmp(ExpInfo.session, 'A')
            ...
            Resp = staircaseVisualStim_dot(i, j, ExpInfo,...
        ...
        if ismember(i_total, ExpInfo.easy_trial)
            ...
            if strcmp(ExpInfo.session, 'A')
                ...
                Resp = staircaseVisualStim_dot(i_easy, j_easy, ExpInfo,...
