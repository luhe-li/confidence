...
%
% LAST UPDATED: Antonio Fernandez 032221
%               Added generalized eta squared and bayes factor
% References:   Bakeman 2005; Masson 2011
%
%
...
% Bayes Factor
dBIC = s*log(SSE/(SSE+SSA))+v1*log(s);
BF   = exp(dBIC/2);
...
fprintf('--------------------------------------------------------------------------------------------\n');
disp('SOV                  SS          df           MS             F        P       GES       BF')
fprintf('--------------------------------------------------------------------------------------------\n');
fprintf('Subjects      %11.3f%10i%15.3f[%13.3f%9.4f]\n\n',SSS,v2,MSS,F2,P2);
fprintf('IV            %11.3f%10i%15.3f%14.3f%9.4f%9.4f%9.4f**\n\n',SSA,v1,MSA,F1,P1,ges,BF);
fprintf('Error         %11.3f%10i%15.3f\n\n',SSE,v3,MSE);
fprintf('Total         %11.3f%10i                  BIC scores (H0/H1):[%9.4f%9.4f]**\n\n',SST,dfT,[pBIC_H0,pBIC_H1]);
fprintf('--------------------------------------------------------------------------------------------\n');
