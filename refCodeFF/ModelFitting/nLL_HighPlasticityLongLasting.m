function [nLL, R1, R2] = nLL_HighPlasticityLongLasting(a_A, b_A, sigma_P,...
    sigma_A, sigma_V, sigma_AV_A, sigma_AV_V, epsilon, pC1_pre_cong,...
...
%               2nd dimension, trial number
nLL_matching    = calculateNLL_matching(a_A, b_A, a_V, b_V, c_A, c_V, f_A, f_V,...
...
function nLL_matching = calculateNLL_matching(a_A, b_A, a_V, b_V, c_A, c_V, f_A,...
