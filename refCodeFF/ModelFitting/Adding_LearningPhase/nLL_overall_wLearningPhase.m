function [nLL, R1, R2] = nLL_overall_wLearningPhase(a_A, b_A, sigma_A, ...
    sigma_V, sigma_AV_A, sigma_AV_V, epsilon, pC1_pre_cong, pC1_post_cong,...
...
for i = 1:length(model.cond) 
    ...
    nLL_learning(i) = calculateNLL_learning(pC1(i,end), s_A, s_V, a_A, b_A, ...
        sigma_AV_A, sigma_AV_V, epsilon, CI, mu_P, lapse_unity_i, ...
