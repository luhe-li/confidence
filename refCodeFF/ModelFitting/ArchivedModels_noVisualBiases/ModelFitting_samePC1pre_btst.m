...
subjN = 23;  %   8,  18,  21, 23,  24
subjI = 'JH';%'NH','ZL','LL','JH', 'MD'
...
%--------------------------------------------------------------------------
model.lb  = [1.5,-10, 1e-1, 1e-3,1e-1, 1e-3, 0.1, 1e-2,1e-2, 1e-2, 1e-4, 1e-4, 1e-4];
model.ub  = [3.5,  5,   15,    5,  15,   10,  10, 0.99,0.99, 0.99, 0.06, 0.06, 0.06];
model.plb = [  2, -5,    1,  0.1,   5,    2,   1,  0.1, 0.1,  0.1, 1e-2, 1e-2, 1e-2];
...
parfor n = 1:model.numBtst
    ...
    nLogL   = @(p) nLL_overall_samePC1pre(p(1),p(2),p(3),p(4),p(5),p(6),...
                p(7),p(8),p(9),p(10),p(11),p(12),p(13),D_btst{n},model);
