...
%p(8)       : pC1
%p(9)-p(11) : lapse rate for the matching task and the unity judgments for
%               the congruent and incongruent condition
%--------------------------------------------------------------------------
nLogL     = @(p) nLL_null(p(1),p(2),p(3),p(4),p(5),p(6),p(7),p(8),p(9),...
                          p(10),p(11),data,model);
model.lb  = [1.5,-10, 1e-1, 1e-3,1e-1, 1e-3, 0.1, 1e-2, 1e-4, 1e-4, 1e-4];
