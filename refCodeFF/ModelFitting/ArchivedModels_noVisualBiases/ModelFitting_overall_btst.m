...
subjN = 19;    %   3,  4,  6,   9,  11,  12, 19, 20
subjI = 'RE'; %'PW','SW','YZ','ZZ','BB','ZY','RE','MM'
...
%e.g., 'SW-full-strategyMAP_MA_strategyUnity_posteriorC1'
...
model.ub  = [  3,  2,   15,    5,  15,   10,  20, 0.99, 0.99,0.99, 0.99, 0.06, 0.06, 0.06];
...
parfor n = 1:model.numBtst
    ...
    nLogL   = @(p) nLL_overall(p(1),p(2),p(3),p(4),p(5),p(6),p(7),p(8),p(9),...
                               p(10),p(11),p(12),p(13),p(14),D_btst{n},model);
