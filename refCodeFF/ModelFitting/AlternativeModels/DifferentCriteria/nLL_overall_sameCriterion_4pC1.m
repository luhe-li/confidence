function [nLL, R1, R2] = nLL_overall_sameCriterion_4pC1(a_A, b_A, sigma_A, sigma_V,...
    sigma_AV_A, sigma_AV_V, criterion, pC1_pre_cong, pC1_post_cong, pC1_pre_incong,...
    pC1_post_incong, lapse_matching,lapse_unity_cong, lapse_unity_incong, data, model)
...
for i = 1:length(model.cond) 
    ...
    for j = 1:length(model.phase) 
        ...
        [nLL_bimodal(i,j),R2{i,j}] = calculateNLL_bimodal(pC1(i,j), data.s_A,...
            data.s_V, a_A, b_A, sigma_AV_A, sigma_AV_V, criterion, CI, mu_P,...
