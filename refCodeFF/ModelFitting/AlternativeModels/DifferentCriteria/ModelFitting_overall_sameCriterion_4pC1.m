...
%p(7)       : c,the criterion is the integration window for some strategies
...
%--------------------------------------------------------------------------
nLogL     = @(p) nLL_overall_sameCriterion_4pC1(p(1),p(2),p(3),p(4),p(5),p(6),...
            p(7),p(8),p(9),p(10),p(11),p(12),p(13),p(14),data,model);
model.lb  = [0.5,-20, 1e-1, 1e-3,1e-1,1e-1, 0.1, 1e-2, 1e-2, 1e-2, 1e-2, 1e-4, 1e-4, 1e-4];
model.ub  = [  3, 10,   15,    5,  15,  10,  20, 0.99, 0.99, 0.99, 0.99, 0.06, 0.06, 0.06];
...
if strcmp(model.strategy_unity,'posteriorC1')
    model.lb(7) = 0.01; model.ub(7) = 0.99; model.plb(7) = 0.2; model.pub(7) = 0.8;
end
model.numRuns     = 20;
model.numSect_bds = 4;
...
save(['ModelFitting_updatePrior_sameCriterion_4pC1_strategyMAP_', model.strategy_MAP, ...
