function [nLL, R1, R2] = nLL_overall_samePC1pre_HA(a_A, b_A, sigma_A, sigma_V,...
    sigma_AV_A, sigma_AV_V, epsilon, pC1_pre, pC1_post_cong, pC1_post_incong,...
    lapse_matching, lapse_unity_cong, lapse_unity_incong, weight, data, model)
