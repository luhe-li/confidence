function [nLL, R1, R2] = nLL_overall_diffSigma(a_A, b_A, sigma_A, sigma_V,...
    sigma_AV_A_pre, sigma_AV_A_post_cong, sigma_AV_A_post_incong, ...
    sigma_AV_V_pre, sigma_AV_V_post_cong, sigma_AV_V_post_incong, ...
    epsilon, pC1_pre_cong, pC1_post_cong,pC1_pre_incong, pC1_post_incong,...
    lapse_matching, lapse_unity_cong, lapse_unity_incong, data, model)
