...
out1FileName            = ['BimodalLocalization_post_sub', num2str(ExpInfo.subjID),...
...
ExpInfo.numTrials         = 10; %for each AV pair
...
BimodalLocalization_post_data = {ExpInfo, ScreenInfo, VSinfo, AudInfo, Response};
save(out1FileName,'BimodalLocalization_post_data');
Screen('CloseAll');
