...
out1FileName            = ['Adaptation_incongruent_sub', num2str(ExpInfo.subjID),...
...
ExpInfo.numTrials         = 5; %for each AV pair
...
ExpInfo.numTrials_unity_perPair = ExpInfo.numTrials*0.2; %8 for each trial type, so 32 in total
ExpInfo.bool_unityReport        = zeros(1,ExpInfo.numTotalTrials);%1: insert unity judgment
for i = 1:ExpInfo.numAVpairs
...
Adaptation_incongruent_data = {ExpInfo, ScreenInfo, VSinfo, AudInfo, Response};
save(out1FileName,'Adaptation_incongruent_data');
Screen('CloseAll');
