...
out1FileName            = ['Adaptation_sub', num2str(ExpInfo.subjID),...
...
ExpInfo.numTrials         = 20; %for each AV pair
...
ExpInfo.numTrials_unity_perPair = ExpInfo.numTrials*0.4; %8 for each trial type, so 32 in total
...
Adaptation_data = {ExpInfo, ScreenInfo, VSinfo, AudInfo, Response};
save(out1FileName,'Adaptation_data');
Screen('CloseAll');
