function [optRadius,maxGain,AllGainFun] = eGain(myPDF, estX, maxScore, minScore, elbow, screenX)
% myPDF    : two-dimensional, size equals [trial, screenX]
...
%            minScore
% screenX  : grid of possible estimates
