...
% confidence
mc1 = repmat(c1', [1, bi_nrep]);
mc2 = repmat(c2', [1, bi_nrep]);
mc3 = repmat(c3', [1, bi_nrep]);

bi_conf = NaN(size(est_var));
bi_conf(est_var < mc1) = 4; 
bi_conf(est_var >= mc1 & est_var < mc2) = 3;
bi_conf(est_var >= mc2 & est_var < mc3) = 2;
bi_conf(est_var >= mc3) = 1;
