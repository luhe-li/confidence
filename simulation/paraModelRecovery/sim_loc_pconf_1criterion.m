function [loc, conf, variance] = sim_loc_pconf_1criterion(num_rep, sA, sV, aA, bA, sigA, sigV, sigP, pCommon, criterion, fixP)

%sim_loc_pconf simulates localization responses, confidence judgements,
%for a bimodal audiovisual stimulus.
%
%Assumes that visual and auditory variance share the same criterion, which
...
% for d = 1:3
%     for modality = 1:2
%         conf(d,modality,:) = variance(d,modality,:) < criterion(d,modality);
%     end
% end
